...
function setupDeclaration(context, reflection, node) {
    ...
    reflection.setFlag(index_1.ReflectionFlag.Protected, !!(node.flags & ts.NodeFlags.Protected));
    reflection.setFlag(index_1.ReflectionFlag.Public, !!(node.flags & ts.NodeFlags.Public));
