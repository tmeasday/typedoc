...
export declare function createCompilerDiagnostic(message: ts.DiagnosticMessage, ...args: any[]): ts.Diagnostic;
...
export declare function getDirectoryPath(path: string): any;
...
export declare function getJsDocComments(node: ts.Node, sourceFileOfNode: ts.SourceFile): any;
